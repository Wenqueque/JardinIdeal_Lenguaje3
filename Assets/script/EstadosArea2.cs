...
public class EstadosArea2 : MonoBehaviour
{
    ...
    private bool estaMirandoFuente = false; // Variable para verificar si el jugador est� mirando un objeto con el tag "Fuente"
    public float radioDeteccionFuente = 1.0f; // Radio de detecci�n de la esfera de colisi�n
    ...
    private void Update()
    {
        ...
        // Verifica si se lleg� al l�mite de interacciones con la fuente y vecesRegadas es igual a 1
        if (interaccionesConFuente >= limiteInteraccionesFuente)
        {
            // Reinicia los par�metros apropiados aqu�
        ...
        // Obtener la posici�n y la direcci�n de la mirada del jugador
        Vector3 posicionCamara = Camera.main.transform.position;
        Vector3 miradaDireccion = Camera.main.transform.forward;

        // Lanzar una esfera de colisi�n en la direcci�n de la mirada para verificar objetos con el tag "Fuente"
        ...
        //if (Input.GetKeyDown(KeyCode.E) && estaMirandoFuente)
        {
            ...
            {
                // Realiza las acciones de interacci�n con la fuente aqu�

                // Despu�s de la interacci�n, espera un tiempo antes de permitir otra interacci�n
                ...
                // Verifica si hemos llegado al �ltimo estado y marcamos el cambio como finalizado
                if (estadoActualIndexFuente == 4) // �ndice del �ltimo estado
                {
                    cambioFinalizadoFuente = true;
                }

                Debug.Log("Interacci�n con la fuente");
                interaccionesConFuente++; // Incrementa el contador de interacciones

                vecesRegadas = 0; // Reinicia el contador de riegos
                AudioManagerSingleton.Instance.PlaySound(0); // 0 es el �ndice del sonido que deseas reproducir
            }
        }
    }
    ...
    // Este m�todo se llama cuando colisionas con un objeto que tiene el tag "Fuente".
    ...
    // Este m�todo se llama cuando dejas de colisionar con un objeto que tiene el tag "Fuente".
